...
static valve_t v0 = {
    .open = {.time = {.hour = 8, .minute = 38, .second = 0}},
    .close = {.time = {.hour = 2, .minute = 30, .second = 0}},
};
static valve_t v1 = {
    .open = {.time = {.hour = 8, .minute = 30, .second = 0}},
...
static const int8_t ports[] PROGMEM = {PB0, PB1, PB2};
...
{
  VALVES_PORT &= ~(1 << pgm_read_byte(&ports[v_idx]));
}
//////////////////////////////////////////////////////////////
